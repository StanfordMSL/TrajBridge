...
(cl:defmethod cl:initialize-instance :after ((m <GcsCmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GcsCmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bridge_px4-srv:<GcsCmd-request> is deprecated: use bridge_px4-srv:GcsCmd-request instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <GcsCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bridge_px4-srv:mode-val is deprecated.  Use bridge_px4-srv:mode instead.")
  (mode m))

(cl:ensure-generic-function 'trigger-val :lambda-list '(m))
(cl:defmethod trigger-val ((m <GcsCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bridge_px4-srv:trigger-val is deprecated.  Use bridge_px4-srv:trigger instead.")
  (trigger m))
...
(cl:defmethod cl:initialize-instance :after ((m <GcsCmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GcsCmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bridge_px4-srv:<GcsCmd-response> is deprecated: use bridge_px4-srv:GcsCmd-response instead.")))
...
(cl:defmethod pose_init-val ((m <GcsCmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bridge_px4-srv:pose_init-val is deprecated.  Use bridge_px4-srv:pose_init instead.")
  (pose_init m))

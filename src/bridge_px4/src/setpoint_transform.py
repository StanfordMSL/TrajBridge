...
class SetpointTransform:
    def __init__(self):
        # Input Params
        drone_id   = rospy.get_param("setpoint_transform/drone_id")
        self.x_off = rospy.get_param("setpoint_transform/x_offset")
        self.y_off = rospy.get_param("setpoint_transform/y_offset")
        self.z_off = rospy.get_param("setpoint_transform/z_offset")

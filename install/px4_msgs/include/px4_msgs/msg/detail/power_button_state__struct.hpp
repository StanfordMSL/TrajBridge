...
#ifndef PX4_MSGS__MSG__DETAIL__POWER_BUTTON_STATE__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__POWER_BUTTON_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__PowerButtonState __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__PowerButtonState __declspec(deprecated)
#endif
...
struct PowerButtonState_
{
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::PowerButtonState_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::PowerButtonState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::PowerButtonState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::PowerButtonState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::PowerButtonState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::PowerButtonState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::PowerButtonState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::PowerButtonState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::PowerButtonState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__PowerButtonState
    std::shared_ptr<px4_msgs::msg::PowerButtonState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__PowerButtonState
    std::shared_ptr<px4_msgs::msg::PowerButtonState_<ContainerAllocator> const>
...
#endif  // PX4_MSGS__MSG__DETAIL__POWER_BUTTON_STATE__STRUCT_HPP_

...
px4_msgs__msg__ButtonEvent__create()
{
  ...
  px4_msgs__msg__ButtonEvent * msg = (px4_msgs__msg__ButtonEvent *)allocator.allocate(sizeof(px4_msgs__msg__ButtonEvent), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__ButtonEvent__Sequence__init(px4_msgs__msg__ButtonEvent__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__ButtonEvent *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__ButtonEvent), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__ButtonEvent__Sequence * array = (px4_msgs__msg__ButtonEvent__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__ButtonEvent__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }

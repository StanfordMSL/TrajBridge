...
{
  new (message_memory) px4_msgs::msg::CameraStatus(_init);
}

void CameraStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::CameraStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CameraStatus_message_member_array[3] = {
  {
    ...
    offsetof(px4_msgs::msg::CameraStatus, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::CameraStatus, active_sys_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::CameraStatus, active_comp_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CameraStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(px4_msgs::msg::CameraStatus),
...
{
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::CameraStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, CameraStatus)() {
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::CameraStatus_message_type_support_handle;
}

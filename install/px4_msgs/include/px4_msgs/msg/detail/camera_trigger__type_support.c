...
#include <stddef.h>
#include "px4_msgs/msg/detail/camera_trigger__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember CameraTrigger__rosidl_typesupport_introspection_c__CameraTrigger_message_member_array[4] = {
  {
    ...
    offsetof(px4_msgs__msg__CameraTrigger, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__CameraTrigger, timestamp_utc),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__CameraTrigger, seq),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__CameraTrigger, feedback),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CameraTrigger__rosidl_typesupport_introspection_c__CameraTrigger_message_members = {
  ...
  4,  // number of fields
  sizeof(px4_msgs__msg__CameraTrigger),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, CameraTrigger)() {

...
px4_msgs__msg__Gripper__create()
{
  ...
  px4_msgs__msg__Gripper * msg = (px4_msgs__msg__Gripper *)allocator.allocate(sizeof(px4_msgs__msg__Gripper), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__Gripper__Sequence__init(px4_msgs__msg__Gripper__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__Gripper *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__Gripper), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__Gripper__Sequence * array = (px4_msgs__msg__Gripper__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__Gripper__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }

...
{
  new (message_memory) px4_msgs::msg::ActuatorServosTrim(_init);
}

void ActuatorServosTrim_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::ActuatorServosTrim *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ActuatorServosTrim_message_member_array[2] = {
  {
    ...
    offsetof(px4_msgs::msg::ActuatorServosTrim, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    8,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::ActuatorServosTrim, trim),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ActuatorServosTrim_message_members = {
  ...
  2,  // number of fields
  sizeof(px4_msgs::msg::ActuatorServosTrim),
...
{
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::ActuatorServosTrim_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, ActuatorServosTrim)() {
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::ActuatorServosTrim_message_type_support_handle;
}

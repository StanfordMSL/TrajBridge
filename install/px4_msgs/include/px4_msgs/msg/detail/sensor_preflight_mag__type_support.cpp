...
{
  new (message_memory) px4_msgs::msg::SensorPreflightMag(_init);
}

void SensorPreflightMag_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::SensorPreflightMag *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SensorPreflightMag_message_member_array[2] = {
  {
    ...
    offsetof(px4_msgs::msg::SensorPreflightMag, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::SensorPreflightMag, mag_inconsistency_angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SensorPreflightMag_message_members = {
  ...
  2,  // number of fields
  sizeof(px4_msgs::msg::SensorPreflightMag),
...
{
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::SensorPreflightMag_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, SensorPreflightMag)() {
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::SensorPreflightMag_message_type_support_handle;
}

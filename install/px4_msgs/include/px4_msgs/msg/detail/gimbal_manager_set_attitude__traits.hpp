...
#ifndef PX4_MSGS__MSG__DETAIL__GIMBAL_MANAGER_SET_ATTITUDE__TRAITS_HPP_
#define PX4_MSGS__MSG__DETAIL__GIMBAL_MANAGER_SET_ATTITUDE__TRAITS_HPP_
...
template<>
inline const char * name<px4_msgs::msg::GimbalManagerSetAttitude>()
{
  return "px4_msgs/msg/GimbalManagerSetAttitude";
}
...
template<>
struct is_message<px4_msgs::msg::GimbalManagerSetAttitude>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4_MSGS__MSG__DETAIL__GIMBAL_MANAGER_SET_ATTITUDE__TRAITS_HPP_

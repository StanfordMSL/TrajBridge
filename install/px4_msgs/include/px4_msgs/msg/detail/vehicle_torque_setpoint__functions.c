...
bool
px4_msgs__msg__VehicleTorqueSetpoint__are_equal(const px4_msgs__msg__VehicleTorqueSetpoint * lhs, const px4_msgs__msg__VehicleTorqueSetpoint * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
px4_msgs__msg__VehicleTorqueSetpoint__copy(
  const px4_msgs__msg__VehicleTorqueSetpoint * input,
  px4_msgs__msg__VehicleTorqueSetpoint * output)
{
  if (!input || !output) {
    return false;
  }
...
px4_msgs__msg__VehicleTorqueSetpoint__create()
{
  ...
  px4_msgs__msg__VehicleTorqueSetpoint * msg = (px4_msgs__msg__VehicleTorqueSetpoint *)allocator.allocate(sizeof(px4_msgs__msg__VehicleTorqueSetpoint), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__VehicleTorqueSetpoint__Sequence__init(px4_msgs__msg__VehicleTorqueSetpoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__VehicleTorqueSetpoint *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__VehicleTorqueSetpoint), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__VehicleTorqueSetpoint__Sequence * array = (px4_msgs__msg__VehicleTorqueSetpoint__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__VehicleTorqueSetpoint__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
px4_msgs__msg__VehicleTorqueSetpoint__Sequence__are_equal(const px4_msgs__msg__VehicleTorqueSetpoint__Sequence * lhs, const px4_msgs__msg__VehicleTorqueSetpoint__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4_msgs__msg__VehicleTorqueSetpoint__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
px4_msgs__msg__VehicleTorqueSetpoint__Sequence__copy(
  const px4_msgs__msg__VehicleTorqueSetpoint__Sequence * input,
  px4_msgs__msg__VehicleTorqueSetpoint__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4_msgs__msg__VehicleTorqueSetpoint);
    px4_msgs__msg__VehicleTorqueSetpoint * data =
      (px4_msgs__msg__VehicleTorqueSetpoint *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__VehicleTorqueSetpoint__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__VehicleTorqueSetpoint__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4_msgs__msg__VehicleTorqueSetpoint__copy(

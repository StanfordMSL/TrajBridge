...
#include <stddef.h>
#include "px4_msgs/msg/detail/camera_status__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember CameraStatus__rosidl_typesupport_introspection_c__CameraStatus_message_member_array[3] = {
  {
    ...
    offsetof(px4_msgs__msg__CameraStatus, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__CameraStatus, active_sys_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__CameraStatus, active_comp_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CameraStatus__rosidl_typesupport_introspection_c__CameraStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(px4_msgs__msg__CameraStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, CameraStatus)() {

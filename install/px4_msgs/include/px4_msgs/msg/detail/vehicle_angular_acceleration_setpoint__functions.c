...
px4_msgs__msg__VehicleAngularAccelerationSetpoint__Sequence__init(px4_msgs__msg__VehicleAngularAccelerationSetpoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__VehicleAngularAccelerationSetpoint *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__VehicleAngularAccelerationSetpoint), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__VehicleAngularAccelerationSetpoint__Sequence * array = (px4_msgs__msg__VehicleAngularAccelerationSetpoint__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__VehicleAngularAccelerationSetpoint__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }

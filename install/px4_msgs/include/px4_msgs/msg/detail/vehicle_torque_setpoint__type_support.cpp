...
{
  new (message_memory) px4_msgs::msg::VehicleTorqueSetpoint(_init);
}

void VehicleTorqueSetpoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::VehicleTorqueSetpoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleTorqueSetpoint_message_member_array[3] = {
  {
    ...
    offsetof(px4_msgs::msg::VehicleTorqueSetpoint, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::VehicleTorqueSetpoint, timestamp_sample),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::VehicleTorqueSetpoint, xyz),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleTorqueSetpoint_message_members = {
  ...
  3,  // number of fields
  sizeof(px4_msgs::msg::VehicleTorqueSetpoint),
...
{
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleTorqueSetpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, VehicleTorqueSetpoint)() {
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleTorqueSetpoint_message_type_support_handle;
}

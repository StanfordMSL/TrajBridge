...
void UwbGrid__rosidl_typesupport_introspection_c__UwbGrid_init_function(
...
void UwbGrid__rosidl_typesupport_introspection_c__UwbGrid_fini_function(void * message_memory)
{
  px4_msgs__msg__UwbGrid__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember UwbGrid__rosidl_typesupport_introspection_c__UwbGrid_message_member_array[17] = {
  {
    "timestamp",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers UwbGrid__rosidl_typesupport_introspection_c__UwbGrid_message_members = {
  "px4_msgs__msg",  // message namespace
  "UwbGrid",  // message name
  17,  // number of fields
  sizeof(px4_msgs__msg__UwbGrid),
  UwbGrid__rosidl_typesupport_introspection_c__UwbGrid_message_member_array,  // message members
  UwbGrid__rosidl_typesupport_introspection_c__UwbGrid_init_function,  // function to initialize message memory (memory has to be allocated)
  UwbGrid__rosidl_typesupport_introspection_c__UwbGrid_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t UwbGrid__rosidl_typesupport_introspection_c__UwbGrid_message_type_support_handle = {
  0,
  &UwbGrid__rosidl_typesupport_introspection_c__UwbGrid_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, UwbGrid)() {
  if (!UwbGrid__rosidl_typesupport_introspection_c__UwbGrid_message_type_support_handle.typesupport_identifier) {
    UwbGrid__rosidl_typesupport_introspection_c__UwbGrid_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &UwbGrid__rosidl_typesupport_introspection_c__UwbGrid_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif

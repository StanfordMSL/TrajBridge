...
{
  new (message_memory) px4_msgs::msg::MavlinkTunnel(_init);
}

void MavlinkTunnel_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::MavlinkTunnel *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MavlinkTunnel_message_member_array[6] = {
  {
    ...
    offsetof(px4_msgs::msg::MavlinkTunnel, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::MavlinkTunnel, payload_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::MavlinkTunnel, target_system),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::MavlinkTunnel, target_component),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::MavlinkTunnel, payload_length),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    128,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::MavlinkTunnel, payload),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MavlinkTunnel_message_members = {
  ...
  6,  // number of fields
  sizeof(px4_msgs::msg::MavlinkTunnel),
...
{
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::MavlinkTunnel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, MavlinkTunnel)() {
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::MavlinkTunnel_message_type_support_handle;
}

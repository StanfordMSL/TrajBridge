...
px4_msgs__msg__SensorAccel__Sequence__init(px4_msgs__msg__SensorAccel__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__SensorAccel *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__SensorAccel), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__SensorAccel__Sequence * array = (px4_msgs__msg__SensorAccel__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__SensorAccel__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }

...
px4_msgs__msg__SensorGyroFifo__create()
{
  ...
  px4_msgs__msg__SensorGyroFifo * msg = (px4_msgs__msg__SensorGyroFifo *)allocator.allocate(sizeof(px4_msgs__msg__SensorGyroFifo), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__SensorGyroFifo__Sequence__init(px4_msgs__msg__SensorGyroFifo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__SensorGyroFifo *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__SensorGyroFifo), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__SensorGyroFifo__Sequence * array = (px4_msgs__msg__SensorGyroFifo__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__SensorGyroFifo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
